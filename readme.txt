...
To run for homework: python3 preprocess.py indels.arff preprocessOutput.txt
...
To run for homework: python3 normalize.py preprocessOutput.txt normalizeOutput.txt
...
To run for homework: python3 experiment.py
